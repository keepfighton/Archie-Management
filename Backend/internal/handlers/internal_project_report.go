...
<div class="header"><div><div class="brand">Archie Management</div><div class="subtitle">Internal Project Management Summary</div></div><div class="meta">Printed {{.PrintedAt}}{{if .From}}<br>Period {{.From}} - {{.To}}{{end}}</div></div>
